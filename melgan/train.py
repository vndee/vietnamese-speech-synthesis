...
import common
import common.configs.melgan as MELGAN_CONFIG
from melgan.audio_mel_dataset import AudioMelDataset
from common.losses import TFMelSpectrogram
from common.models import TFMelGANGenerator, TFMelGANMultiScaleDiscriminator
from common.trainers import GanBasedTrainer
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Train MelGAN (See detail in common/bin/train-melgan.py)"
    )
    parser.add_argument(
        "--train-dir",
        default=None,
    ...
    config["version"] = common.__version__
