...
from melgan_stft.train_melgan_stft import MultiSTFTMelganTrainer
...
from common.utils import return_strategy
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Train Hifigan (See detail in hifigan/train_hifigan.py)"
    )
    parser.add_argument(
        "--train-dir",
        default=None,
